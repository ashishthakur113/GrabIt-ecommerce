    ...
    <div className="w-full bg-white px-4 sm:px-10 py-12 md:py-20">
      <div className="max-w-screen-xl mx-auto flex flex-col-reverse md:flex-row items-center justify-center gap-y-10 md:gap-x-16">
        ...
        >
          ...
          <Link to="/aboutus">
            <button className="bg-blue-600 hover:bg-blue-700 transition cursor-pointer text-white px-5 py-2 rounded mt-2">
              About Us
            </button>
          </Link>
        </motion.div>
        ...
        >
          <img
            ...
            height="420"
            loading="eager"
            className="w-[90%] sm:w-[80%] md:w-[350px] lg:w-[420px] h-auto max-h-[420px] object-contain"
          />
        </motion.div>
      </div>
    </div>
