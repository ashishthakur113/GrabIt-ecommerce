...
export default function Header() {
  ...
  const navLinkStyle = ({ isActive }) => `text-sm lg:text-lg ${isActive ? "text-yellow-400  font-semibold" : " "} `;
  ...
  return (
    <div className='sm:mb-5 mb-0 lg:mb-0'>
      <nav className="w-full text-white shadow-md fixed top-0 left-0 z-50 bg-[#073b4c]" >
        <div className="flex justify-between items-center h-22 px-6 md:px-12">
          <div className='flex'>
            <div className="md:text-3xl text-2xl font-bold font-serif text-blue-500 mr-0 md:mr-4 ">
              <NavLink to='/' className='flex items-center  md:gap-1'>
               <img src={logo} className='w-10 h-10' />Grab<span className="text-orange-400 font-mono">It</span>
              </NavLink> 
            </div>
        ...
        <div className=" lg:hidden px-4  mb-2 w-full flex justify-center">
